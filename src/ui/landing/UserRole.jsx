    ...
    return (
        <section id='features' className="px-8 pb-16 text-center">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-6">
                <div className="dark:bg-veryDarkViolet bg-white shadow-md flex flex-col items-center gap-4 p-8 rounded-lg w-full md:w-1/3">
                    <UserCog className='w-20 h-20 dark:text-slate-50 text-darkViolet' />
                    <div className='flex flex-col'>
                        <h4 className="font-bold text-darkViolet text-xl dark:text-slate-50">Renter</h4>
                ...
                <div className="dark:bg-veryDarkViolet bg-white shadow-md flex flex-col items-center gap-4 p-8 rounded-lg w-full md:w-1/3">
                    <User className='w-20 h-20 dark:text-slate-50 text-darkViolet' />
                    <div className='flex flex-col'>
                        <h4 className="font-bold text-darkViolet text-xl dark:text-slate-50">Lender</h4>
                        <ul className="text-darkViolet dark:text-grayishViolet mt-2 text-sm text-left list-disc ml-4">
