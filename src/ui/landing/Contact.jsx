...
export default function Contact() {
    return (
        <section id='contact' className="bg-darkViolet text-white text-center px-8 py-24">
            <h3 className="md:text-4xl text-3xl lg:text-5xl font-bold mb-2">Get in touch</h3>
            <p className="mb-4 text-[13px] md:text-base">Have questions or want to learn more? Reach out to us!</p>
